...
public class MessageListener {
      ...
      @KafkaListener(topics = "${messaage.topic.name}", groupId = "foo", containerFactory = "fooKafkaListenerContainerFactory")
      public void listenGroupFoo(String message) {
          System.out.println("Received Messasge in group 'foo': " + message);
          latch.countDown();
      }

      @KafkaListener(topics = "${messaage.topic.name}", groupId = "bar", containerFactory = "barKafkaListenerContainerFactory")
      public void listenGroupBar(String message) {
          System.out.println("Received Messasge in group 'bar': " + message);
          latch.countDown();
      }

      @KafkaListener(topics = "${messaage.topic.name}", containerFactory = "headersKafkaListenerContainerFactory")
      ...
      @KafkaListener(topics = "${greetings.topic.name}", containerFactory = "greetingKafkaListenerContainerFactory")
